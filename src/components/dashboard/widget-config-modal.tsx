...
import { useWidgetConfig, type WidgetConfig, type WidgetVariable } from '@/src/contexts/widget-config-context'
import { useDashboard } from '@/lib/dashboard-context'
import { WIDGET_SIZES, type WidgetSize } from '@/src/Constants/widget-sizes'
